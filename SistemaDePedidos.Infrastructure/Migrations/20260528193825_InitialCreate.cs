        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientProfiles_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SellerProfiles_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_ClientProfiles_ClientProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientProfiles_UserId1",
                table: "ClientProfiles",
                column: "UserId1",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellerProfiles_UserId1",
                table: "SellerProfiles",
                column: "UserId1",
                unique: true,
                filter: "[UserId1] IS NOT NULL");
